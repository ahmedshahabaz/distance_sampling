...
class InferenceHelper:
    def __init__(self, dataset='nyu', device='cuda:0'):
        ...
        if dataset == 'nyu':
            ...
            #pretrained_path = "/home/mithrandir/Documents/PhD/Projects/animal/Depth-Anything-V2/other_MODELS/AdaBins/checkpoints/AdaBins_nyu-256-2fb686a.pth" #AdaBins_nyu.pt"
            pretrained_path = "/home/mithrandir/Documents/PhD/Projects/animal/Depth-Anything-V2/other_MODELS/AdaBins/checkpoints/AdaBins_nyu.pt" #AdaBins_nyu.pt"
        elif dataset == 'kitti':
            self.min_depth = 1e-3
            self.max_depth = 80
            self.saving_factor = 256
            model = UnetAdaptiveBins.build(n_bins=256, min_val=self.min_depth, max_val=self.max_depth)
            pretrained_path = "/home/mithrandir/Documents/PhD/Projects/animal/Depth-Anything-V2/other_MODELS/AdaBins/checkpoints/AdaBins_kitti-256-2fb686a.pth" #AdaBins_kitti.pt"
            #pretrained_path = "/home/mithrandir/Documents/PhD/Projects/animal/Depth-Anything-V2/other_MODELS/AdaBins/checkpoints/AdaBins_kitti.pt" #AdaBins_kitti.pt"
        else:
